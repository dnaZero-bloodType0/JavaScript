...
function basketbol (godishnaTaksa) {

let cenaKecove = godishnaTaksa - (godishnaTaksa * 0.4);
let cenaEkip = cenaKecove - (cenaKecove * 0.2);
let cenaTopka = cenaEkip / 4;
let cenaAksesoari = cenaTopka / 5;
let vsichkiRazhodi = cenaAksesoari+cenaTopka+cenaEkip+cenaKecove+godishnaTaksa;

console.log(vsichkiRazhodi);
