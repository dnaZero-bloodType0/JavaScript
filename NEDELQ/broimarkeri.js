...
function allMoney(broiPhimikali, broiPmarkeri, litriPreparat, namalenie){

let paketHimikalki = broiPhimikali * 5.80;
let paketMarkeri = broiPmarkeri * 7.20;
let litarPreparat = litriPreparat * 1.20;
let obshtaSuma = paketHimikalki+paketMarkeri+litarPreparat;
let procentNamalenie = namalenie / 100;
let kolkoPari = obshtaSuma - (obshtaSuma* procentNamalenie);
console.log(kolkoPari);
